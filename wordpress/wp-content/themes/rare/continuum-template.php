            ...
            <div id="continuum-container">
                ...
                <div id="species-container">
                    <map id="species-hover-map" name="species-hover-map">
                        ...
                        <area id="frog" shape="poly" coords="253,167,264,166,271,163,275,160,278,154,276,143,268,148,265,155,255,161,250,166" alt="<?php echo get_field('popup_content', $species['frogs']->ID) . '<span class=\'wiki-link\'><a href=\'' . get_field('wiki_link', $species['frogs']->ID) . '\' target=\'_blank\'>' . get_field('wiki_link', $species['frogs']->ID) . '</a></span>'; ?>" title="<?php echo $species['frogs']->post_title . '<em>' . get_field('latin_name', $species['frogs']->ID) . '</em>'; ?>" href="#" data-target="#species-frog" />
                        ...
                        <area id="pigeon" shape="poly" coords="432,29,417,23,409,5,403,7,400,16,399,23,399,34,387,28,382,28,377,37,368,43,379,49,392,48,406,52,395,44,398,36,404,31,414,34,424,35,430,33" alt="<?php echo get_field('popup_content', $species['passenger-pigeon']->ID) . '<span class=\'wiki-link\'><a href=\'' . get_field('wiki_link', $species['passenger-pigeon']->ID) . '\' target=\'_blank\'>' . get_field('wiki_link', $species['passenger-pigeon']->ID) . '</a></span>'; ?>" title="<?php echo $species['passenger-pigeon']->post_title . '<em>' . get_field('latin_name', $species['passenger-pigeon']->ID) . '</em>'; ?>"  href="#" data-target="#species-pigeon" />
