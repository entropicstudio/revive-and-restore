...
?>
        ...
        <div class="span-20 prepend-1 append-1">
            ...
            <div id="continuum-container">
                ...
                <h1>Stages of Species Endangerment</h1>
                ...
                <h2>How Biotechnology Can Help</h2>

                <ul id="biotech-list">
                    <li>Comparative Genomics</li>
                    <li>Ancient Genome Assembly</li>
                    <li>Cloning</li>
                    <li>Synthetic DNA</li>
                    <li>Germ Line Transmission</li>
