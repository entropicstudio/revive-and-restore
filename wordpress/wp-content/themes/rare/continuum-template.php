            ...
            <div id="continuum-container">
                ...
                <div id="species-container">
                    <map id="species-hover-map" name="species-hover-map">
                        ...
                        <area id="frog" shape="poly" coords="254.20000457763672,161,263.2000045776367,158,263.2000045776367,166,251.20000457763672,167,252.20000457763672,163" alt="<?php echo get_field('popup_content', $species['frogs']->ID) . '<span class=\'wiki-link\'><a href=\'' . get_field('wiki_link', $species['frogs']->ID) . '\' target=\'_blank\'>' . get_field('wiki_link', $species['frogs']->ID) . '</a></span>'; ?>" title="<?php echo $species['frogs']->post_title . '<em>' . get_field('latin_name', $species['frogs']->ID) . '</em>'; ?>" href="#" data-target="#species-frog" />
                        <area id="frog2" shape="poly" coords="266,161,267,151,272,145,275,144,278,154,274,160,270,158,268,160"  alt="<?php echo get_field('popup_content', $species['frogs']->ID) . '<span class=\'wiki-link\'><a href=\'' . get_field('wiki_link', $species['frogs']->ID) . '\' target=\'_blank\'>' . get_field('wiki_link', $species['frogs']->ID) . '</a></span>'; ?>" title="<?php echo $species['frogs']->post_title . '<em>' . get_field('latin_name', $species['frogs']->ID) . '</em>'; ?>" href="#" data-target="#species-frog2" />
